...
def get_topic_feedback(request):
    if request.method == "GET":
        ...
        try:
                ...
                if msg is None:
                    if last_none is not None:
                        ...
                        if current - last_none > 1000:
                            return render(request, '../templates/django_kafka/django_kafka/feedback.html',
                                          {'topic_data': data})
            ...
            consumer.close()
        return render(request, '../templates/django_kafka/django_kafka/feedback.html', {'topic_data': data})
